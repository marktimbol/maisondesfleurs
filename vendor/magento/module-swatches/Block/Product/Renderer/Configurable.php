    ...
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function addSwatchDataForAttribute(
        ...
        // var_dump('swatchesCollectionArray', $swatchesCollectionArray);

        foreach ($options as $optionId => $label) {
            // var_dump('Option ID', $optionId);
            // var_dump('Label', $label);
            // var_dump('isset swatchesCollectionArray option id', isset($swatchesCollectionArray[$optionId]));
            // var_dump('----------');
    ...
    {
        // var_dump('use_product_image_for_swatch', $attributeDataArray['use_product_image_for_swatch']);
