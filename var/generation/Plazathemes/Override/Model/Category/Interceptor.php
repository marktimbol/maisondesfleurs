...
class Interceptor extends \Plazathemes\Override\Model\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageUrl2');
        if (!$pluginInfo) {
            return parent::getImageUrl2($image_type);
        } else {
            return $this->___callPlugins('getImageUrl2', func_get_args(), $pluginInfo);
        }
    }
