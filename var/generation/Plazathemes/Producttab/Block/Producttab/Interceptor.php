...
class Interceptor extends \Plazathemes\Producttab\Block\Producttab implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSaleProduct()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSaleProduct();
        } else {
            return $this->___callPlugins('getSaleProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRandomProduct');
        if (!$pluginInfo) {
            return parent::getRandomProduct();
        } else {
            return $this->___callPlugins('getRandomProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMostviewsProduct');
        if (!$pluginInfo) {
            return parent::getMostviewsProduct();
        } else {
            return $this->___callPlugins('getMostviewsProduct', func_get_args(), $pluginInfo);
        }
    }
